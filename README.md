...
## Table of Contents
- [Image Shadow Detection](#image-shadow-detection)
...
- [Image Shadow Removal](#image-shadow-removal)
  ...
  - [Metrics](#metrics-2)
  - [Papers](#papers-3)
- [Video Shadow Removal](#video-shadow-removal)
  - [Papers](#papers-4)
- [Document Shadow Removal](#document-shadow-removal)
  ...
  - [Dataset](#dataset-1)
  - [Papers](#papers-5)
- [Facial Shadow Removal](#facial-shadow-removal)
  - [Papers](#papers-6)
...
4. **ViShadow**: Xing et al., "Video instance shadow detection under the sun and sky", TIP, 2024. [[paper]](https://arxiv.org/abs/2211.12827)  
...
- RMSE \& PSNR with don't care: [this repository](https://github.com/xw-hu/Unveiling-Deep-Shadows/blob/main/eval_ShadowRemoval_DESOBA.py)
...
4. **Zheng et al.**: Zheng et al., "Learning to shadow hand-drawn sketches", CVPR, 2020. (for Sketch)  [[paper]](https://openaccess.thecvf.com/content_CVPR_2020/html/Zheng_Learning_to_Shadow_Hand-Drawn_Sketches_CVPR_2020_paper.html)
5. **Shadow Matting GAN**: Cun et al., "Towards ghost-free shadow removal via dual hierarchical aggregation network and shadow matting GAN", AAAI, 2020. (for Shadow Removal)  [[paper]](https://ojs.aaai.org/index.php/AAAI/article/view/6695)
6. **SSN**: Sheng et al., "SSN: Soft shadow network for image compositing", CVPR, 2021. (for Composition)  [[paper]](https://openaccess.thecvf.com/content/CVPR2021/html/Sheng_SSN_Soft_Shadow_Network_for_Image_Compositing_CVPR_2021_paper.html)
7. **G2R-ShadowNet**: Liu et al., "From shadow generation to shadow removal", CVPR, 2021. (for Shadow Removal)  [[paper]](https://openaccess.thecvf.com/content/CVPR2021/html/Liu_From_Shadow_Generation_To_Shadow_Removal_CVPR_2021_paper.html)
8. **SmartShadow**: Zhang et al., "SmartShadow: Artistic shadow drawing tool for line drawings", ICCV, 2021. (for Sketch)  [[paper]](https://openaccess.thecvf.com/content/ICCV2021/html/Zhang_SmartShadow_Artistic_Shadow_Drawing_Tool_for_Line_Drawings_ICCV_2021_paper.html)
9. **SSG**: Sheng et al., "Controllable shadow generation using pixel height maps", ECCV, 2022. (for Composition)  [[paper]](https://link.springer.com/chapter/10.1007/978-3-031-20050-2_15)
10. **SGRNet**: Hong et al., "Shadow generation for composite image in real-world scenes", AAAI, 2022. (for Composition)  [[paper]](https://ojs.aaai.org/index.php/AAAI/article/view/19974)
11. **Liu et al.**: Liu et al., "Shadow generation for composite image with multi-level feature fusion", EITCE, 2022. (for Composition)  [[paper]](https://dl.acm.org/doi/pdf/10.1145/3573428.3573675)
12. **PixHt-Lab**: Sheng et al., "PixHt-Lab: Pixel height based light effect generation for image compositing", CVPR, 2023. (for Composition)  [[paper]](https://openaccess.thecvf.com/content/CVPR2023/html/Sheng_PixHt-Lab_Pixel_Height_Based_Light_Effect_Generation_for_Image_Compositing_CVPR_2023_paper.html)
13. **HAU-Net & IFNet**: Meng et al., "Automatic shadow generation via exposure fusion", TMM, 2023. (for Composition)  [[paper]](https://ieeexplore.ieee.org/abstract/document/10043015)
14. **Valença et al.**: Valença et al., "Shadow harmonization for realistic compositing", SIGGRAPH Asia, 2023. (for Composition)  [[paper]](https://dl.acm.org/doi/pdf/10.1145/3610548.3618227)
15. **DMASNet**: Tao et al., "DMASNet: Shadow generation with decomposed mask prediction and attentive shadow filling", AAAI, 2024. (for Composition)  [[paper]](https://ojs.aaai.org/index.php/AAAI/article/view/28326)
16. **SGDiffusion**: Liu et al., "SGDiffusion: Shadow generation for composite image using diffusion model", CVPR, 2024. (for Composition)  [[paper]](https://openaccess.thecvf.com/content/CVPR2024/html/Liu_Shadow_Generation_for_Composite_Image_Using_Diffusion_Model_CVPR_2024_paper.html)
